...
finger_tip_x = int((landmarks[8].x)*width)
 ...
 cv2.line(image,(finger_tip_x,finger_tip_y),(thumb_tip_x,thumb_tip_y),(225,0,0),2)

 centre_x = int((finger_tip_x + thumb_tip_x)/2)	
 centre_y = int((finger_tip_y + thumb_tip_y)//2)

 cv2.circle(image,(centre_x,centre_y),2,(0,0,225),2)
 ...
 relative_mouse_x = (centre_x/weidth)*screen_weidth
 relative_mouse_y = (centre_x/height)*screen_height
